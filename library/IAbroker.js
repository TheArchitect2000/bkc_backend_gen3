// Previous Name: IAbroker.js
const mosca = require('mosca');
const iabroker_version = '3.0';

const dbConfig = require('../configs/mongo.config');
const brokerConfig = require('../configs/which.config');
const IADevice = require('./back-end/models/iadevice.model');
const IADeviceController = require('./back-end/controllers/iadevice.controller');
const IAActivity = require('./back-end/models/iaactivity.model');
const IAHome = require('./back-end/models/iahome.model');
...
// Service Runner
const IAServiceRunner = require('./back-end/utilities/iaservice/IAService');
