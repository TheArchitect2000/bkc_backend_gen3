...
const iamailer = require('../utilities/iacommunication/iamailer');
...
router.get('/vendor', (req, res, next) => {
    ...
    if(signedin && customer && customer.vendor) {
        ...
        res.sendFile(path.resolve('library/front-end/customer/views/iacustomer.customer.login.html'))
    }
...
router.get('/', (req, res, next) => {
    ...
    let loginpage = 'library/front-end/customer/views/iacustomer.customer.login.html';
