...
app.use('/admin*', require('./routes/customer.routes'));
...
app.use('/iahome', require('./routes/iahome.routes'));
app.use('/iavendor', require('./routes/iavendor.routes'));
app.use('/iadevice', require('./routes/iadevice.routes'));
app.use('/iacustomer', require('./routes/iacustomer.routes'));
app.use('/iaservice', require('./routes/iaservice.routes'));
app.use('/iaactivity', require('./routes/iaactivity.routes'));
app.use('/installedservice', require('./routes/installedservice.routes'));
app.use('/iafs', require('./routes/iafileserver.routes'));
app.use('/iavoice', require('./routes/iavoice.routes'));
app.use('/iaticket', require('./routes/iaticket.routes'));
app.use('/iadevicetype', require('./routes/iadevicetype.routes'));
...
if(require('./config/which.config').debugmongoose)
